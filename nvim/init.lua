...
Plug('Mofiqul/dracula.nvim', { ['as'] = 'dracula' }) --dracula colorscheme
...
Plug('williamboman/mason-lspconfig.nvim') --mason + lspconfig integration
...
Plug('folke/todo-comments.nvim') --highlight TODO, NOTE, etc.
