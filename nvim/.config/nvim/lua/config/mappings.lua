...
-- todo-comments
map("n", "<leader>td", ":TodoTelescope<CR>") --find all todos
map("n", "<leader>tl", ":TodoLocList<CR>") --todos in location list
map("n", "<leader>tq", ":TodoQuickFix<CR>") --todos in quickfix
map("n", "]t", function() require("todo-comments").jump_next() end) --next todo
map("n", "[t", function() require("todo-comments").jump_prev() end) --prev todo
